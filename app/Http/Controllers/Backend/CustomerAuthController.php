...
//        Auth::logoutOtherDevices(request('password'));
    ...
    public function CustomerLogin(Request $request)
    {
        ...
        if (Auth::attempt($credentials)) {
			...
			return redirect()->back()->withFail(__('Your email address or password incorrect.'));
		}
    }
...
//                    'regex:/[0-9]/',
            ...
            $messages = [
                ...
                'password.regex'   => 'The Password  is invalid,password must be 8 characters in length. contain at least one lowercase letter at least one uppercase letter and special character',
    ...
    protected function resetPassword(Request $request){
		...
		if($userCount < 1) {
			return redirect()->back()->withFail( __('If your email exists in our database, you will receive a reset link'));
		}
