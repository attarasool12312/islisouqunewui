...
Route::get('/thanks/{order_no}', [App\Http\Controllers\Frontend\CheckoutFrontController::class, 'LoadThanks'])->name('frontend.thanks');
...
Route::prefix('backend')->group(function(){
    ...
    Route::get('/products-export', [App\Http\Controllers\Backend\ProductsController::class,'export'])->name('products.export')->middleware(['auth','is_admin']);
    Route::post('/products-import', [App\Http\Controllers\Backend\ProductsController::class,'import'])->name('products.import')->middleware(['auth','is_admin']);
	//Update
