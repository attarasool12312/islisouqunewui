					...
					<div class="register">
						...
						<form class="form" method="POST" action="{{ route('frontend.resetPassword') }}">
							...
							<div class="form-group">
								<input name="email" type="email" class="form-control emailalphanumericonly @error('email') is-invalid @enderror" placeholder="{{ __('Email Address') }}" value="{{ old('email') }}" autocomplete="off" required />
                                @if ($errors->has('email'))
