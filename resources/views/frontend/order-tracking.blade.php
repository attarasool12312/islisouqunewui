					...
					<div class="register shadow_bg_off">
						...
						<form class="form" method="GET" action="{{ route('frontend.order-tracking') }}">
							<div class="form-group">
								<input name="order_no" type="text" class="form-control alphanumericonly" placeholder="{{ __('Order#') }}" required />
							</div>
							<div class="form-group">
								<input name="email" type="email" class="form-control emailalphanumericonly" placeholder="{{ __('Email Address') }}" required />
							</div>
