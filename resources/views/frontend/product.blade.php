			...
			<div class="row">
				<div class="col-xl-5">
					<div class="product-details-slider pd-slider-for">
						...
						<div class="item">
							<img src="{{ asset('public/media/'.$row->thumbnail) }}" alt="{{ $key }}"  style="height:200px;width: 200px" />
						</div>
						@endforeach
						@else
						<div class="item">
				...
				<div class="col-xl-7">
					<div class="pr_details">
						...
						<div class="pr_quantity">
							...
							<input class="numberonlyHere" name="quantity" id="quantity" type="number" min="1" max="{{ $data->is_stock == 1 ? $data->stock_qty : 999 }}" value="1" onkeyup="if(parseInt(this.value)>{{ $data->is_stock == 1 ? $data->stock_qty : 999 }}){ this.value={{$data->is_stock == 1 ? $data->stock_qty : 999}}; return false; }">
						</div>
					...
					<div class="col-lg-12">
						<div class="item-card">
							<div class="item-image">
								...
								@endif
								<a href="{{ route('frontend.product', [$row->id, $row->slug]) }}"><img src="{{ asset('public/media/'.$row->f_thumbnail) }}" alt="{{ $row->title }}" style="height:200px;width: 200px"/ ></a>
							</div>
