						...
						<form method="GET" action="{{ route('frontend.search') }}">
							<div class="search-card">
								<div class="search-box">
									<input name="search" type="text" class="form-control alphanumericonly" placeholder="{{ __('Search for Products') }}..." required />
								</div>
...
{{--									<li><a href="{{ route('frontend.getProductCategoryGrid') }}" class="btn cat-more-btn catMoreBtnActive"><span class="onCatMoreBtn">{{ __('Show More') }}</span></a></li>--}}
								</ul>
							</li>
						</ul>
					</div>
