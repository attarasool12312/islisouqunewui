				...
				<div class="col-lg-12">
					<div class="featured-card">
						<div class="featured-image">
							<img src="{{ asset('public/media/'.$row->thumbnail) }}" alt="{{ $row->name }}"  style="height:200px;width: 200px" />
						</div>
					...
					<div class="item-card">
						<div class="item-image">
							...
							<a href="{{ route('frontend.product', [$row->id, $row->slug]) }}">
								<img src="{{ asset('public/media/'.$row->f_thumbnail) }}" alt="{{ $row->title }}"  style="height:200px;width: 200px" />
							</a>
						</div>
					...
					<div class="offer-card" style="background:{{ $aRow->bg_color == '' ? '#daeac5' : $aRow->bg_color }};">
						...
						<div class="offer-footer">
							...
							<div class="offer-image">
								<img src="{{ asset('public/media/'.$row->image) }}" alt="{{ $aRow->text_1 }}" style="height:200px;width: 200px" />
							</div>
						</div>
					</div>
				</div>
