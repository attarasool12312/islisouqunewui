									...
									<div class="row">
										<div class="col-md-12">
											<div class="mb-3">
												...
												<input id="name" name="name" type="text" class="form-control alphanumericonly" placeholder="{{ __('Name') }}" value="@if(isset(Auth::user()->name)) {{ Auth::user()->name }} @endif" required />
												@if ($errors->has('name'))
									...
									<div class="row">
										<div class="col-md-12">
											<div class="mb-3">
												...
												<input id="phone" name="phone" type="text" class="form-control phoneNumberonly"  maxlength="13" placeholder="{{ __('Phone') }}" value="@if(isset(Auth::user()->phone)) {{ Auth::user()->phone }} @endif" />
											</div>
										</div>
									</div>
									<div class="row">
										<div class="col-md-12">
											<div class="mb-3">
												...
												<textarea id="address" name="address" class="form-control emailalphanumericonly" placeholder="{{ __('Address') }}" rows="4">@if(isset(Auth::user()->address)) {{ Auth::user()->address }} @endif</textarea>
											</div>
										</div>
									</div>
									<div class="row">
