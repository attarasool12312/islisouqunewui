				...
				<div class="row">
					<div class="col-lg-7">
						...
						<div class="row">
							...
							<div class="col-md-6">
								<div class="mb-3">
									<input id="phone" name="phone" type="text" placeholder="{{ __('Phone') }}" value="@if(isset(Auth::user()->phone)) {{ Auth::user()->phone }} @endif" class="form-control parsley-validated phoneNumberonly" data-required="true" maxlength="12">
						...
						<div class="row">
							...
							<div class="col-md-6">
								<div class="mb-3">
									<input id="state" name="state" type="text" placeholder="{{ __('State') }}" class="form-control parsley-validated alphanumericonly" data-required="true">
						...
						<div class="row">
							<div class="col-md-6">
								<div class="mb-3">
									<input id="zip_code" name="zip_code" type="text" placeholder="{{ __('Zip Code') }}" class="form-control parsley-validated numberonlyHere" data-required="true" maxlength="10">
									<span class="text-danger error-text zip_code_error"></span>
								</div>
							</div>
							<div class="col-md-6">
								<div class="mb-3">
									<input id="city" name="city" type="text" placeholder="{{ __('City') }}" class="form-control parsley-validated alphanumericonly" data-required="true">
						...
						<div class="row">
							<div class="col-md-12">
								<div class="mb-3">
									<textarea id="address" name="address" placeholder="{{ __('Address') }}" rows="2" class="form-control parsley-validated alphanumericonly" data-required="true">@if(isset(Auth::user()->address)) {{ Auth::user()->address }} @endif</textarea>
...
{{--															@endif--}}
											...
											<tr>
												<td>
													<div class="">
													<img src="{{ asset('public/media/'.$row['thumbnail']) }}" alt="{{ $row['name'] }}" width="60" height="30"  class="embed-responsive"/>
													</div>
											...
											<tr>
												<td>
													<div class="">
														<img src="{{ asset('public/media/'.$row['thumbnail']) }}" alt="{{ $row['name'] }}"  width="50" height="60" class="embed-responsive"/>
													</div>
			...
			<div name="mini-player" id="mini-player"></div> 
					<script>
						new VideeoSDK('mini-player', {
							shopName: 'capitalwalletvideeo',
							miniPlayer: true,
						});
					</script>
		</div>
