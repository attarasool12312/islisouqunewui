									...
									<div class="row">
										<div class="col-md-12">
											<div class="mb-3">
												...
												<input id="current_password" name="current_password" type="password" class="form-control alphanumericonly" placeholder="{{ __('Current password') }}" required />
									...
									<div class="row">
										<div class="col-md-12">
											<div class="mb-3">
												...
												<input type="password" name="password" id="password" class="form-control alphanumericonly" placeholder="{{ __('New password') }}" required />
									...
									<div class="row">
										<div class="col-md-12">
											<div class="mb-3">
												...
												<input type="password" name="password_confirmation" id="password_confirmation" class="form-control alphanumericonly" placeholder="{{ __('Password confirmation') }}" required />
