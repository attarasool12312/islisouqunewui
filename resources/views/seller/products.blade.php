							...
							<div class="row">
								<div class="col-lg-12">
									<div class="form-group">
										...
										<input type="text" name="title" id="title" class="form-control parsley-validated alphanumericonly" data-required="true">
									</div>
								</div>
							</div>
							<div class="row">	
								<div class="col-md-12">
									<div class="form-group">
										...
										<input type="text" name="slug" id="slug" class="form-control parsley-validated alphanumericonly" data-required="true">
									</div>
								</div>
							</div>
							<div class="row">	
