								...
								<div class="row">
									<div class="col-lg-12">
										<div class="form-group">
											...
											<input value="{{ $datalist['title'] }}" type="text" name="title" id="product_name" class="form-control parsley-validated alphanumericonly" data-required="true">
										</div>
									</div>
								</div>
								<div class="row">
									<div class="col-lg-12">
										<div class="form-group">
											...
											<input value="{{ $datalist['slug'] }}" type="text" name="slug" id="slug" class="form-control parsley-validated alphanumericonly" data-required="true">
										</div>
									</div>
								</div>
								<div class="row">
									<div class="col-lg-12">
										<div class="form-group">
											...
											<textarea name="short_desc" id="short_desc" class="form-control alphanumericonly" rows="2">{{ $datalist['short_desc'] }}</textarea>
										</div>
									</div>
								</div>
								<div class="row">
									<div class="col-lg-12">
										<div class="form-group tpeditor">
											...
											<textarea name="description" id="description" class="form-control alphanumericonly" rows="4">{{ $datalist['description'] }}</textarea>
										</div>
									</div>
								</div>
								<div class="row">
