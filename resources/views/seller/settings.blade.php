								...
								<div class="row">
									<div class="col-md-6">
										<div class="form-group">
											...
											<input type="text" name="shop_name" id="shop_name" value="{{ $seller_data['shop_name'] }}" class="form-control parsley-validated alphanumericonlySeller" data-required="true" maxlength="10">
										</div>
									</div>
									...
									<div class="col-md-6">
										<div class="form-group">
											...
											<input type="text" name="shop_url" id="shop_url" value="{{ $seller_data['shop_url'] }}" class="form-control parsley-validated alphanumericonlySeller" data-required="true" maxlength="10">
										</div>
									</div>
								</div>
								...
								<div class="row">
									<div class="col-md-6">
										<div class="form-group">
											...
											<input type="text" name="phone" id="phone" value="{{ $seller_data['phone'] }}" class="form-control parsley-validated phoneNumberonly"  maxlength="13" data-required="true">
										</div>
									</div>
									<div class="col-md-6">
										<div class="form-group">
											<label for="address">{{ __('Address') }}<span class="red">*</span></label>
											<input type="text" name="address" id="address" value="{{ $seller_data['address'] }}" class="form-control parsley-validated alphanumericonly" data-required="true" maxlength="10">
										</div>
									</div>
								</div>
								<div class="row">
									<div class="col-md-6">
										<div class="form-group">
											...
											<input type="text" name="city" id="city" value="{{ $seller_data['city'] }}" class="form-control parsley-validated alphanumericonly" data-required="true" maxlength="10">
										</div>
									</div>
									<div class="col-md-6">
										<div class="form-group">
											<label for="state">{{ __('State') }}<span class="red">*</span></label>
											<input type="text" name="state" id="state" value="{{ $seller_data['state'] }}" class="form-control parsley-validated alphanumericonly" data-required="true" maxlength="10">
										</div>
									</div>
								</div>
								...
								<div class="row">
									<div class="col-md-6">
										<div class="form-group">
											...
											<input type="text" name="zip_code" id="zip_code" value="{{ $seller_data['zip_code'] }}" class="form-control parsley-validated alphanumericonly" data-required="true" maxlength="10">
										</div>
									</div>
									<div class="col-md-6">
										<div class="form-group">
								...
								<div class="row">
									<div class="col-md-6">
										<div class="form-group">
											...
											<input type="text" name="bank_name" id="bank_name" value="{{ $bank_information['bank_name'] }}" class="form-control alphanumericonly" maxlength="30">
										</div>
									</div>
									<div class="col-md-6">
										<div class="form-group">
											<label for="bank_code">{{ __('Bank Code/IFSC') }}</label>
											<input type="text" name="bank_code" id="bank_code" value="{{ $bank_information['bank_code'] }}" class="form-control alphanumericonly" maxlength="5">
										</div>
									</div>
								</div>
								...
								<div class="row">
									<div class="col-md-6">
										<div class="form-group">
											...
											<input type="text" name="account_number" id="account_number" value="{{ $bank_information['account_number'] }}" class="form-control alphanumericonly" maxlength="15">
										</div>
									</div>
									<div class="col-md-6">
										<div class="form-group">
											<label for="account_holder">{{ __('Account Holder Name') }}</label>
											<input type="text" name="account_holder" id="account_holder" value="{{ $bank_information['account_holder'] }}" class="form-control alphanumericonly" maxlength="30ß">
										</div>
									</div>
								</div>
								...
								<div class="row">
									<div class="col-md-12">
										<div class="form-group">
											...
											<input type="text" name="paypal_id" id="paypal_id" value="{{ $bank_information['paypal_id'] }}" class="form-control alphanumericonly" maxlength="10">
										</div>
									</div>
								</div>
								...
								<div class="row">
									<div class="col-md-12">
										<div class="form-group">
											...
											<textarea name="description" id="description" class="form-control alphanumericonly" rows="3">{{ $bank_information['description'] }}</textarea>
										</div>
									</div>
								</div>
...
$('.alphanumericonlySeller').bind('keyup blur',function(){
	var node = $(this);
...
$('.emailalphanumericonly').bind('keyup blur',function(){
	var node = $(this);
	node.val(node.val().replace(/[^a-z0-9@. ]/g,'') ); }
);

$('.urlcharactorsconly').bind('keyup blur',function(){
	var node = $(this);
	node.val(node.val().replace(/[^a-z0-9//. ]/g,'') ); }
);
$('.phoneNumberonly').bind('keyup blur',function(){
	var node = $(this);
	node.val(node.val().replace(/[^0-9+. ]/g,'') ); }
);

$('.numberonlyHere').bind('keyup blur',function(){
	var node = $(this);
